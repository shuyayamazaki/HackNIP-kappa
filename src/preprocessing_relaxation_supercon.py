...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default='/home/lucky/Projects/ion_conductivity/ion_conductivity/data/final/MP/3DSC_MP.csv', help="Path to the dataset CSV file")
    parser.add_argument("--property_cols", type=json.loads, default=['tc'], help="List of property columns to use")
