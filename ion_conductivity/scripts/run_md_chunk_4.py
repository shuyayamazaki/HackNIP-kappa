...
print(len(df))
# Parallelize above
results = Parallel(n_jobs=10)(delayed(run_md_simulation)(row['data_temperature_value'], i, "orb", 4, False) for i, row in df.iterrows())

# Save results
df['diffusivity_orb'] = results
df.to_parquet('/home/lucky/Projects/ion_conductivity/data/MPContribs_armorphous_diffusivity_orb_4.parquet')
